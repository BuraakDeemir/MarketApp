...
namespace BussinesLayer
{
	public class User : BaseUser
	{
		...
		public override void AddNewAdress(int PersonId, string Adress)
		{
		...
		public void AddNewAdress(int PersonId, string Adress,string City,string District)
		{
			TblKisiAdres TblAdressForAdd = new TblKisiAdres()
			{
				KisiId = PersonId,
		...
		public List<YeniAdresTablosu> GetCity(int AdressId)
		{
		...
		public override void SingUp(string Name, string Surname, string UserName, string Pass, string Phone, string Email, string Adress)
		{
		...
		public void SingUp(string Name, string Surname, string UserName, string Pass, string Phone, string Email, string Adress, string City,string District)
		{
			DateTime CreateDate = DateTime.Now;
			TblKisi tblPersonAdd = new TblKisi()
			{
		...
		public override void UpdateAdress(int AdressId, string Adress)
		{
