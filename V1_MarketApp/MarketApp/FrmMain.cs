...
namespace MarketApp
{
...

	{
		...
		{
			ShowProductByCategories(sender); //Ürünler Buttonuna tıklandığında dinamik olarak oluşturulan Linklabel...
		}
		...
		private void BtnAdress_Click(object sender, EventArgs e)
		{
			...
			BtnAdressAdd.Margin = new Padding(80, 30, 50, 0);
			BtnAdressAdd.BackColor = Color.IndianRed;
		...
		private void ShowCategories()
		{
			...
			if (Counter == 1)
			{
				...
				foreach (var item in Context.TblKategori)
				{
					...
					LblCategory.Margin = new Padding(15, 10, 0, 10);
					LblCategory.Font = new Font("Arial", 14);
		...
		private void ShowProductByCategories(object sender)
		{
			...
			foreach (var item in result)
			{
				...
				PnlProductCard.Height = 350;
				PnlProductCard.Width = 220;
				PnlProductCard.Name = (item.UrunId).ToString();
				PnlProductCard.Parent = panel3;
				PnlProductCard.Margin = new Padding(10, 10, 10, 40);
				PnlProductCard.BackColor = Color.IndianRed;

				Panel pnlImg = new Panel();
				pnlImg.Height = 200;
				pnlImg.Width = 200;
				pnlImg.Margin = new Padding(10, 10, 10, 10);
				...
				lblProductName.Margin = new Padding(10, 0, 10, 0);
				...
				lblProductprice.Height = 40;
				lblProductprice.Width = 200;
				lblProductprice.Margin = new Padding(10, 0, 10, 0);
				lblProductprice.Name = (item.BirimFiyat).ToString();
				lblProductprice.ForeColor = Color.White;
				lblProductprice.Font = new Font("Arial", 13);
				...
				BtnProductAdd.Width = 200;
				BtnProductAdd.Height = 40;
				BtnProductAdd.FlatStyle = FlatStyle.Flat;
				BtnProductAdd.Name = item.UrunId.ToString();
				BtnProductAdd.Text = "Sepete Ekle";
				BtnProductAdd.Font = new Font("Arial", 12);
				BtnProductAdd.BackColor = Color.IndianRed;
				BtnProductAdd.ForeColor = Color.White;
				BtnProductAdd.Margin = new Padding(10, 0, 10, 0);
		...
		private void SetOrderPiece(object sender)
		{
			...
			PeiceForm.BackColor = Color.IndianRed;
			PeiceForm.Width = 320;
		...
		private void ShowBasketFreeInfo()
		{
			...
			BasketFree.BackColor = Color.IndianRed;
			BasketFree.Name = "BasketFree";
			BasketFree.Margin = new Padding(80, 30, 50, 0);
		...
		private void ShowBasketDetails()
		{
			...
			BtnAllBasketDelete.Margin = new Padding(80, 30, 50, 15);
			BtnAllBasketDelete.BackColor = Color.IndianRed;
			...
			BtnOrderOk.Margin = new Padding(0, 30, 50, 0);
			BtnOrderOk.BackColor = Color.IndianRed;
			...
			foreach (var item in result)
			{
				...
				PnlBasketRight.BackColor = Color.IndianRed;
		...
		private void ShowOrderDetails()
		{
			...
			foreach (var item in result)
			{
				...
				PnlOrder.BackColor = Color.IndianRed;
				PnlOrder.Name = item.OrderId.ToString();
				PnlOrder.Margin = new Padding(80, 15, 50, 30);
				PnlOrder.Parent = panel3;
				PnlOrder.Width = 800;
				PnlOrder.Height = 230;

				FlowLayoutPanel PnlOrderLeft = new FlowLayoutPanel();
				PnlOrderLeft.BackColor = Color.IndianRed;
				...
				PnlOrderRight.BackColor = Color.IndianRed;
				...
				BtnOrderDetails.BackColor = Color.IndianRed;
		...
		private void ShowAdressFreeInfo()
		{
			...
			AdressFree.BackColor = Color.IndianRed;
			AdressFree.Name = "AdressFree";
			AdressFree.Margin = new Padding(80, 20, 50, 0);
		...
		private void ShowAdressDetails()
		{
			...
			foreach (var item in TblPersonAdress)
			{
				...
				PnlAdress.BackColor = Color.IndianRed;
				PnlAdress.Name = item.AdresId.ToString();
				PnlAdress.Margin = new Padding(80, 30, 50, 0);
				...
				PnlAdressLeft.BackColor = Color.IndianRed;
				...
				PnlAdressCenter.BackColor = Color.IndianRed;
				...
				PnlAdressRight.BackColor = Color.IndianRed;
				...
				BtnDeleteAdress.BackColor = Color.IndianRed;
				...
				BtnUpdateAdress.BackColor = Color.IndianRed;
